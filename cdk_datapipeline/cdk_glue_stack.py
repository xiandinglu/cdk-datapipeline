"""This Stack is to create the ETL pipeline by using glue services"""
...
class CdkGlueStack(Stack):
    """Create Glue Jobs and Glue Trigger"""
    ...
    def __init__(self, scope: Construct, construct_id: str, **kwargs) -> None:
        ...
        glue.CfnJob(
            ...
            command=glue.CfnJob.JobCommandProperty(
                name="glueetl",
                script_location="""
                    s3://testing-script-1234/glue-script/testing-glue-script
                """,
            ),
            ...
            default_arguments={
                ...
                "--extra-files": """
                    s3://testing-script-1234/log4j-properties-config/log4j.properties
                """,
            },
